...
import 'package:prani_sheba/controller/ReportPregnancyController.dart';
...
class ReportPregnant extends StatefulWidget {
  static const routeName = 'report_pregnant';

  _ReportPregnant createState() => _ReportPregnant();
}

class _ReportPregnant extends State<ReportPregnant> {
  final GlobalKey<ScaffoldState> _key = GlobalKey<ScaffoldState>();

  final ReportPregnancyController reportController = Get.put(ReportPregnancyController());
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.only(top: 0),
                                child: Text(
                                  '${reportController.productList.value.cattleCount}',
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(fontSize: 20, color: Colors.black),
                                ),
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                margin: EdgeInsets.only(top: 5),
                                                                child: Text(
                                                                  'ডেলেভারির সময়ঃ ${DateConverter.formatDateIOS(reportController.dataList[index].expectedDeliveryDate!)}',
                                                                  textAlign: TextAlign.left,
                                                                  maxLines: 1,
                                                                  overflow: TextOverflow.ellipsis,
                                                                  style: TextStyle(fontSize: 15, color: Colors.grey, fontStyle: FontStyle.normal),
