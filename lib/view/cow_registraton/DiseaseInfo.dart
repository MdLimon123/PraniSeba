...
class DiseaseInfo extends StatefulWidget {
  static const routeName = 'disease_info';

  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<DiseaseInfo> {
  String? selectedFarms, selectedCattleId, selectedCattleDisease;
                  ...
                  child: AbsorbPointer(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'অসুস্থ হওয়ার তারিখ (yyyy-MM-dd)',
                      ),
                    ),
                  )),
            ),
                  ...
                  Container(
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items:
                        cattle_diseasesToList!.map((CattleDiseases map) {
                          return DropdownMenuItem<String>(
                              value: map.id.toString(),
                              child: Container(
                                margin: EdgeInsets.only(left: 10),
  ...
  void dataPush() async {
    ...
    await http.post(Uri.parse(NetworkServices.baseUrl + 'form/store-disease-info'), body: {
